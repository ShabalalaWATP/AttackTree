          ...
          <div className="flex items-start justify-between">
            <div>
              <div className="flex items-center gap-5 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Model, simulate, and defend against adversary operations
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6 mt-5">
                <QuickStat icon={<FolderOpen size={14} />} label="Projects" value={projectCount} />
                <QuickStat icon={<GitBranch size={14} />} label="Attack Trees" value={projectCount} accent="cyan" />
      ...
      <div className="max-w-6xl mx-auto px-6 pb-8">
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="Search nodes across all projects..."
        ...
        {showCreate && (
          <div className="border border-border/50 rounded-xl p-5 mb-6 bg-card/80 backdrop-blur-sm shadow-lg">
            <h3 className="font-semibold mb-4 flex items-center gap-2">
              <Plus size={16} className="text-primary" /> Create New Project
            </h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-xs font-medium text-muted-foreground">Project Name</label>
                <input value={newName} onChange={(e) => setNewName(e.target.value)} placeholder="e.g., Q1 Web App Risk Assessment"
              ...
              <div className="col-span-2">
                ...
                <input value={newObjective} onChange={(e) => setNewObjective(e.target.value)} placeholder="e.g., Exfiltrate customer data from the SaaS platform"
                  className="w-full mt-1 px-3 py-2.5 rounded-lg border border-border/50 bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
              </div>
              <div className="col-span-2">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-sm text-muted-foreground mb-6 max-w-xs mx-auto">Create a new attack tree project or start from a template to begin modelling adversary operations.</p>
            ...
            {data.projects.map((p: any) => (
              ...
              >
                ...
                <div className="text-[11px] text-muted-foreground text-right space-y-0.5">
                  ...
                  <div className="text-[10px] px-2 py-0.5 rounded-full bg-muted/50 inline-block">{p.context_preset}</div>
                </div>
